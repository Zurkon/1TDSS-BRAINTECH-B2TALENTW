...
begin:/\b(print|exec)\(/}]}}}());hljs.registerLanguage("javascript",function(){"use strict"
...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
preprocessor:c,strings:s,keywords:u}}}}());hljs.registerLanguage("properties",function(){"use strict";return function(e){
...
relevance:0}],starts:r},{className:"attr",relevance:0,begin:s+n+"$"}]}}}());hljs.registerLanguage("python-repl",function(){"use strict";return function(n){
return{aliases:["pycon"],contains:[{className:"meta",starts:{end:/ |$/,starts:{
end:"$",subLanguage:"python"}},variants:[{begin:/^>>>(?=[ ]|$)/},{
begin:/^\.\.\.(?=[ ]|$)/}]}]}}}());hljs.registerLanguage("java",function(){"use strict";function e(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},c,i]}}}());hljs.registerLanguage("c",function(){"use strict";return function(e){
